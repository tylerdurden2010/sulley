...
s_binary_repeat      = lambda x: custom_raise("NotImplementedError: s_string_variables is not currently implemented.")
...
s_binary_block_size_intel_halfword_plus_variable = lambda x: custom_raise("SizerNotUtilizedError: Use the s_size primitive for including sizes")
s_binary_block_size_halfword_bigendian_variable  = lambda x: custom_raise("SizerNotUtilizedError: Use the s_size primitive for including sizes")
s_binary_block_size_word_bigendian_plussome      = lambda x: custom_raise("SizerNotUtilizedError: Use the s_size primitive for including sizes")
s_binary_block_size_word_bigendian_variable      = lambda x: custom_raise("SizerNotUtilizedError: Use the s_size primitive for including sizes")
s_binary_block_size_halfword_bigendian_mult      = lambda x: custom_raise("SizerNotUtilizedError: Use the s_size primitive for including sizes")
s_binary_block_size_intel_halfword_variable      = lambda x: custom_raise("SizerNotUtilizedError: Use the s_size primitive for including sizes")
s_binary_block_size_intel_halfword_mult          = lambda x: custom_raise("SizerNotUtilizedError: Use the s_size primitive for including sizes")
s_binary_block_size_intel_halfword_plus          = lambda x: custom_raise("SizerNotUtilizedError: Use the s_size primitive for including sizes")
s_binary_block_size_halfword_bigendian           = lambda x: custom_raise("SizerNotUtilizedError: Use the s_size primitive for including sizes")
s_binary_block_size_word_intel_mult_plus         = lambda x: custom_raise("SizerNotUtilizedError: Use the s_size primitive for including sizes")
s_binary_block_size_intel_word_variable          = lambda x: custom_raise("SizerNotUtilizedError: Use the s_size primitive for including sizes")
s_binary_block_size_word_bigendian_mult          = lambda x: custom_raise("SizerNotUtilizedError: Use the s_size primitive for including sizes")
s_blocksize_unsigned_string_variable             = lambda x: custom_raise("SizerNotUtilizedError: Use the s_size primitive for including sizes")
s_binary_block_size_intel_word_plus              = lambda x: custom_raise("SizerNotUtilizedError: Use the s_size primitive for including sizes")
s_binary_block_size_intel_halfword               = lambda x: custom_raise("SizerNotUtilizedError: Use the s_size primitive for including sizes")
s_binary_block_size_word_bigendian               = lambda x: custom_raise("SizerNotUtilizedError: Use the s_size primitive for including sizes")
s_blocksize_signed_string_variable               = lambda x: custom_raise("SizerNotUtilizedError: Use the s_size primitive for including sizes")
s_binary_block_size_byte_variable                = lambda x: custom_raise("SizerNotUtilizedError: Use the s_size primitive for including sizes")
s_binary_block_size_intel_word                   = lambda x: custom_raise("SizerNotUtilizedError: Use the s_size primitive for including sizes")
s_binary_block_size_byte_plus                    = lambda x: custom_raise("SizerNotUtilizedError: Use the s_size primitive for including sizes")
s_binary_block_size_byte_mult                    = lambda x: custom_raise("SizerNotUtilizedError: Use the s_size primitive for including sizes")
s_blocksize_asciihex_variable                    = lambda x: custom_raise("SizerNotUtilizedError: Use the s_size primitive for including sizes")
s_binary_block_size_byte                         = lambda x: custom_raise("SizerNotUtilizedError: Use the s_size primitive for including sizes")
s_blocksize_asciihex                             = lambda x: custom_raise("SizerNotUtilizedError: Use the s_size primitive for including sizes")
s_blocksize_string                               = lambda x: custom_raise("SizerNotUtilizedError: Use the s_size primitive for including sizes")
